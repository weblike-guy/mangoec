...
Spree.config do |config|
  ...
  config.currency = "THB"
  country = Spree::Country.find_by_name('Thailand')
  ...
  SolidusI18n::Config.available_locales = [:en, :es, :th, :ja, :'pt-BR']
  # displayed on frontend select box
  SolidusGlobalize::Config.supported_locales = [:en, :th, :ja, :'pt-BR']
